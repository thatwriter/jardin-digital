<%*
    ...
    let titleInput = await tp.system.prompt("Ingresa el título para el audio:");
    let contextInput = await tp.system.prompt("Ingresa el contexto del audio:");
    let linkInput = await tp.system.prompt("Ingresa el vínculo al audio:");

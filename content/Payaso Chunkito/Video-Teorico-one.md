...
## Pasos
1. Establecer una línea de tiempo, con un par de menciones con registro
2. Definición de técnicas de cada uno de los mencionados
3. Mención de tipos de espectáculos
4. Glosario de conceptos
5. Escritura del guión
6. Storyboard
7. Planeación
8. Grabación
9. Edición
**Nota:** Adicional a cada paso, espero que exista iteración
## Desarrollo
Línea de tiempo
- Bufón 2,500 a.C.
- Comedia del arte
